...
`data.ts` ya rechaza un bundle con `synthesis` y sin aviso, y hoy no dispara porque no hay ninguno
— que es exactamente cuándo hay que poner un control. Después del primer parche sería una
corrección.
